...
out_csv = ROOT / "data" / "quant_features_v5.csv"
out_report = ROOT / "reports" / f"motion_quantification_v5_{datetime.now().strftime('%Y-%m-%dT%H-%M-%S')}.json"
...
report = {
    ...
    "step_executed": "Regenerate quant features from v6 smoothed/extrapolated features",
    ...
    "next_step": "Retrain and compare metrics vs v3 baseline.",
}
