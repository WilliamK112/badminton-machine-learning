...
def main() -> None:
    ...
    feat_file = resolve_input("frame_features_v9.jsonl")
    out_csv_gz = DATA / "quant_features_v9.csv.gz"
    out_report = REPORTS / f"motion_quantification_v6_{datetime.now().strftime('%Y-%m-%dT%H-%M-%S')}.json"
